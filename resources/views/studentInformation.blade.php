    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card-body">
          ...
          <form role="form text-left" id="editPaymentForm" action="{{ route('payment.edit', ['child_id' => $student->child->child_id, 'month' => $student->child->payment_1st_month]) }}" method="POST">
            @csrf
