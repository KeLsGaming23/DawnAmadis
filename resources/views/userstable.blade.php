  ...
  rows.forEach(row => {
    row.addEventListener('click', function () {
      ...
      fetch(`/users/${userId}`)
        ...
        .then(responseData => {
          console.log('Response:', responseData); // Log the response data to check its structure

          const user = responseData.data; // Access the "data" property of the response
          ...
          <div class="modal-body">
            ...
            <img src="${user.profile_picture}" alt="Profile Picture" style="border-radius: 50%; width: 200px; height: 200px;">
